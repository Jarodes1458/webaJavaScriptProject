    ...
    <div class="row">
      <div class="col-9" style="margin:auto;">
        ...
        <div class="row">
          ...
          <form action="listeDesPrixControlleur?modif=true">
            <?php
            foreach(getAllCoupePrestation("coupe") as $prestation):
              echo $prestation["SER_NOM"] . "&ensp;";
            if (modificationPossible()){?>
              <a role="button" href="listeDesPrixControlleur?modif=true&idser=<?= $prestation['SER_ID'] ?>"><i class="far fa-edit colorIcon"></i></a>
              
              <a class="far fa-trash-alt" href="listeDesPrixControlleur?id=<?=$prestation['SER_ID']?>" style="color: #55595c;"></a>
            <?php }
              echo "<br>";
            endforeach?>
          </div>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <br>
                    <form method="POST" action="listeDesPrixControlleur">
                      <div class="row">
...
<div class="container">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
          <br>
          <form method="POST" action="listeDesPrixControlleur?idmodif=<?= $service['SER_ID'] ?>">
            <div class="row">
              <div class="col-lg-6 col-md-12">
                <h5>Type: </h5>
                <div class="form-group">
                  <select id="inputTypeM" name="inputTypeM" class="form-control">
                    ...
                    <?php foreach(getAllServiceCategorieExceptOne2($service['SER_TYPE']) as $donneesCategorie): ?>
        ...
        <br>
        <div class="modal-footer">
          <a href="listeDesPrixControlleur"><button type="button" name="comeback" class="btn btn-secondary border border-dark" >Fermer</button></a>
...
<?php }else{
  ?> <meta http-equiv="refresh" content="0;URL=listeDesPrixControlleur"> <?php
}
